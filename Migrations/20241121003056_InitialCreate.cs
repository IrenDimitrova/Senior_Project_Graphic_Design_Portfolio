            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Biography = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DoesPrintDesign = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DoesBrandingDesign = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DoesDigitalDesign = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Does3dDesign = table.Column<bool>(type: "tinyint(1)", nullable: false),
